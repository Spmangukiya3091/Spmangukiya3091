...
@section('main')
    ...
    <div class="w3l-contact-main" style="background:#ccc;">
        <div class="container py-md-5">
            <p>Blood Center is public donation center with blood donation members in the changing health care system. Founded in 2002, Blood Center is one
                of the nation’s oldest and largest nonprofit transfusion medicine organizations. We provide a blood and volunteer services across the US.
                With our national footprint, deep community roots and specialized services, we are the thread that connects people and resources together
                to fuel progress in transfusion medicine.</p>
        </div>
    </div>
            ...
            <div class="container py-lg-5">
                ...
                <div class="content-info-in row">
                    <div class="content-gd col-lg-6 pl-lg-4">
                        ...
                        <blockquote>
                            <p style='font-family:oswald; margin-top: 30px;'>After donating blood, the body works to replenish the blood loss. This
                            ...
                            <div class="stats_left">
                                <div class="counter_grid">
                                    <div class="icon_info">
                                        <p class="counter">
                                            @php
                                                DB::$sql = " SELECT * FROM requests_users join userdata on requests_users.organization_id=userdata.id
