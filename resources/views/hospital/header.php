            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="social-top col-lg-3 mt-lg-0 mt-sm-3">
                        <div class="top-bar-text"> 
                            <a class="dropdown-toggle" data-toggle="dropdown" style="margin: 0px;">Login As</a>
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="Logout.php"><i class="fa fa-power-off fa-fw" aria-hidden="true"></i> logout</a>
                            </div>
                        </div>
                    </div>
                </div>
