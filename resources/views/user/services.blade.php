                ...
                <div class = "row">
                    <div class = "col-lg-4 col-md-6 service_grid_btm_left mt-lg-5 mt-4">
                        <div class = "service_grid_btm_left1">
                            <img src="{{ url("assets/images/g1.jpg") }}"class = "img-fluid" />
                    ...
                    <div class = "col-lg-4 col-md-6 service_grid_btm_left mt-lg-5 mt-4">
                        <div class = "service_grid_btm_left1">
                            <img src="{{ url("assets/images/download1.jpg") }}"class = "img-fluid" style = " height : 230px ; "/>
                            <div class = "service_grid_btm_left2">
                    ...
                    <div class = "col-lg-4 col-md-6 service_grid_btm_left mt-lg-5 mt-4">
                        <div class = "service_grid_btm_left1">
                            <img src="{{ url("assets/images/download3.jpg") }}"class = "img-fluid" />
                            <div class = "service_grid_btm_left2">
                    ...
                    <div class = "col-lg-4 col-md-6 service_grid_btm_left mt-lg-5 mt-4">
                        <div class = "service_grid_btm_left1">
                            <img src="{{ url("assets/images/g3.png") }}"class = "img-fluid" />
                            <div class = "service_grid_btm_left2">
                    ...
                    <div class = "col-lg-4 col-md-6 service_grid_btm_left mt-lg-5 mt-4">
                        <div class = "service_grid_btm_left1">
                            <img src="{{ url("assets/images/download5.jpg") }}"class = "img-fluid" style = " height : 230px ; "/>
                            <div class = "service_grid_btm_left2">
                    ...
                    <div class = "col-lg-4 col-md-6 service_grid_btm_left mt-lg-5 mt-4">
                        <div class = "service_grid_btm_left1">
                            <img src="{{ url("assets/images/download6.jpg") }}"class = "img-fluid" style = " height : 230px ; " />
                            <div class = "service_grid_btm_left2">
            ...
            <div class = "container py-lg-5">
                <div class = "row story-6-grids text-left">
                    <div class = "col-lg-5 story-gd">
                        <a href = "{{ url("{{ url("assets/images/featured-image-1.jpg") }}") }}"><img src="{{ url("assets/images/featured-image-1.jpg") }}" class = "img-fluid"></a>
                    </div>
