...
<footer class="w3l-footer-66">
    ...
    <div class="cpy-right py-3">
        <p class="text-center">© <?php echo date("Y");?> BloodBank. All rights reserved | Design by Roll No.
            <a class="mybtn-profile" data-id='157'> 157 </a>
            <a class="mybtn-profile" data-id='159'> 159 </a>
            <a class="mybtn-profile" data-id='204'> 204 </a>
        </p>
    </div>
    <?php include '157.php';?>
    <?php include '159.php';?>
    ...
    $('document').ready(function(){
      $( ".mybtn-profile" ).each(function( index ) {
          ...
          $(this).on('click',function(){
            ...
            console.log("123");
            if(data_val == '157'){
                $('#myProfile157').css('display','block');
            }
            else if(data_val == '159'){
                $('#myProfile159').css('display','block');
            }
            else{
                $('#myProfile204').css('display','block');
            }
          });
        });
    });
  $('.close-model').on('click',function(){
        $('#myProfile157').css('display','none');
        $('#myProfile159').css('display','none');
        $('#myProfile204').css('display','none');
     });
