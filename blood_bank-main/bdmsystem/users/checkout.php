...
<?php
$YOUR_DOMAIN = 'http://localhost/project-bloodbanks/blood_bank-main/bdmsystem/users';
?>
...
(function() {
  ...
  checkoutButton.addEventListener('click', function () {
    ...
    stripe.redirectToCheckout({
       ...
       */
      successUrl: 'http://localhost/project-bloodbanks/blood_bank-main-main/bdmsystem/users/thanks.php',
      cancelUrl: 'http://localhost/project-bloodbanks/blood_bank-main/bdmsystem/users/cancel.html',
    })
