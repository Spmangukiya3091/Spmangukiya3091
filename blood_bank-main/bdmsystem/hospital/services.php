    ...
    <div class="container py-lg-5 py-md-5">
        ...
        <div class="services-block_grids_bottom">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 service_grid_btm_left mt-lg-5 mt-4">
                    <div class="service_grid_btm_left1">
                        <img src="../assets/images/download.jpg" class="img-fluid" />
                        <div class="service_grid_btm_left2">
                            <h5 class="reg">New Donor</h5>
                            <p>In This You Can Able To Add New Donor And Details.</p>
                            <div class="read">
                                <a class="btn mt-4" href="donors_Registration.php">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
                <!-- <div class="col-lg-4 col-md-6 service_grid_btm_left mt-lg-5 mt-4">
                    <div class="service_grid_btm_left1">
                        ...
                        <div class="service_grid_btm_left2">
                            <h5 class="reg">Requests</h5>
                            <div class="read">
                                <a class="btn mt-4" href="requests.php">Read More</a>
                            </div>
                        </div>
                    </div>
                </div> -->
                <div class="col-lg-4 col-md-6 service_grid_btm_left mt-lg-5 mt-4">
                    <div class="service_grid_btm_left1">
                        <img src="../assets/images/download1.jpg"class="img-fluid" style="height: 230px;"/>
                        <div class="service_grid_btm_left2">
                            <h5 class="reg">Users Request List</h5>
                            <p>You Can Able To See Blood Request From Pateint.</p>
                            <div class="read">
                ...
                <div class="col-lg-4 col-md-6 service_grid_btm_left mt-lg-5 mt-4">
                    <div class="service_grid_btm_left1">
                        ...
                        <div class="service_grid_btm_left2">
                            <h5 class="reg">Requests Status</h5>
                            <p>You Can Able To see Your Request Status That Your Request Approved Or Not.</p>
                            <div class="read">
                                <a class="btn mt-4" href="Requests_list.php">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 service_grid_btm_left mt-lg-5 mt-4">
                    <div class="service_grid_btm_left1">
                        <img src="../assets/images/download4.jpg"class="img-fluid" style="height: 230px;"/>
                        <div class="service_grid_btm_left2">
                            <h5 class="reg">Blood Donor</h5>
                            <p>Here You Can Able To watch Are Blood Donor And Thems All Information.</p>    
                            <div class="read">
                                <a class="btn mt-4" href="donor_list.php">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 service_grid_btm_left mt-lg-5 mt-4">
                    <div class="service_grid_btm_left1">
                        <img src="../assets/images/download2.jpg"class="img-fluid" style="height: 230px;"/>
                        <div class="service_grid_btm_left2">
