...
function send_email($email, $html, $subject)
{
	...
	$mail->SMTPSecure = "tls";
	$mail->SMTPAuth = true;
	$mail->Username = "akkisonani157@gmail.com";
	$mail->Password = "Akshay@10";
	$mail->setFrom("akkisonani157@gmail.com");
	$mail->addAddress($email);
	$mail->addReplyTo('akkisonani157@gmail.com', 'NoReply');
	$mail->IsHTML(true);
...
if ($type == 'forgot') {
  $email =$_POST['email'];
  $res = mysqli_query($conn, "select * from userdata where email='$email'");
