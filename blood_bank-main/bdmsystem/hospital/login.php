...
if (isset($_POST['btnsubmit']) && ($_POST['btnsubmit'])==='Submit'){   
        ...
        $qr         = "SELECT * FROM userdata WHERE email='$email' AND password='$password' AND active=1";
    ...
    <div class="main">
        ...
        <div class="login-div">
            ...
            <div class="link">
                ...
                <a class="mybtn-action" data-id='Registration' href="registration.php">Register</a>
            </div>
            </form>
        </div>
    </div>
